          ...
          <View style={{width: wp("90%"),flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize: hp(2.4)}}>How to verify my Impact11 account?</Text>
                    ...
                    <Text style={{fontWeight:"bold",fontSize: hp(2.2)}}>To Verify PAN card:</Text>
                    ...
                    <Text style={{fontWeight:"bold",fontSize: hp(2.2)}}>To Verify Bank Account:</Text>
