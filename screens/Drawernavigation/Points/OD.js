...
export default function ODScreen(){
  ...
  <View
      ...
      >
        <View style={{ width: wp("55%") }}>
          <Text style={{ fontWeight: "bold" }}>Below 30 runs 100 balls</Text>
        </View>
        <View
          style={{
            width: wp("30%"),
  ...
  <LinearGradient
    ...
    <View
        ...
        >
          <View style={{ width: wp("50%") }}>
            <Text style={{ fontWeight: "bold" }}>Between 2.5 - 3.49 runs per over</Text>
          </View>
          <View
            style={{
              width: wp("35%"),
    ...
    <View
        ...
        >
          <View style={{ width: wp("50%") }}>
            <Text style={{ fontWeight: "bold" }}>Between 3.5 - 4.5 runs per over</Text>
          </View>
          <View
            style={{
              width: wp("35%"),
    ...
    <View
        ...
        >
          <View style={{ width: wp("50%") }}>
            <Text style={{ fontWeight: "bold" }}>Between 7 - 8 runs per over</Text>
          </View>
          <View
            style={{
              width: wp("35%"),
  ...
  <View
      ...
      >
        <View style={{ width: wp("50%") }}>
          <Text style={{ fontWeight: "bold" }}>Between 9 runs per over</Text>
        </View>
        <View
          style={{
            width: wp("35%"),
